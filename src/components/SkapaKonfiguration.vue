...
<template>
  <div class="skapa-konfiguration">
    ...
    <div class="page-intro">
      <p>
        En sorteringsordning styr i vilken ordning uppgifter presenteras för
        handläggare. Du delar upp uppgifterna i prioriteringsgrupper — grupp 1
        har högst prioritet. Varje uppgift hamnar automatiskt i den första
        gruppen vars filter den uppfyller.
      </p>
      <p>
        Exempel: Grupp 1 kan fånga upp brådskande uppgifter med kort planerat
        datum, grupp 2 uppgifter av en viss regeltyp, och grupp 3 alla övriga
        uppgifter.
      </p>
    </div>
        ...
        <div class="entry-body">
          <div class="subsection">
            ...
            <p class="subsection-description">
              ...
              fånga upp alla uppgifter som inte matchades av en tidigare grupp.
            </p>

            <div v-if="entry.constraints.length === 0" class="catchall-notice">
              <strong>Ingen begränsning</strong> – den här gruppen fångar upp
              alla uppgifter som inte matchades av en tidigare grupp. Det är
              vanligt att ha en sådan grupp sist som standardgrupp.
            </div>
          ...
          <div class="subsection subsection--spaced">
            ...
            <p class="subsection-description">
              Välj i vilken ordning uppgifterna i den här gruppen ska visas. Om
              du inte väljer något visas de i den ordning de kom in.
            </p>
...
.page-intro {
  ...
  border-left: 4px solid var(--color-info, #0d6efd);
